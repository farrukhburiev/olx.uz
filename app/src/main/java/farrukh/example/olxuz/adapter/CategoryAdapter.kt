...
class CategoryAdapter(var offers:MutableList<Category>): RecyclerView.Adapter<CategoryAdapter.MyHolder>()  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        var myHolder = LayoutInflater.from(parent.context).inflate(R.layout.category_layout,parent,false)
